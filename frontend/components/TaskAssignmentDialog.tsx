...
// Helper: only real team members with an email
...
interface TaskAssignmentDialogProps {
  ...
  taskName: string;
  canManage?: boolean; // Only team lead should pass true
}
...
export default function TaskAssignmentDialog({
  ...
  // Members eligible to be assigned (unique by id)
  ...
  // Read-only if user cannot manage assignments
  if (!canManage) {
    return (
      <div className="flex items-center gap-1">
        ...
        {/* View dialog for read-only users */}
