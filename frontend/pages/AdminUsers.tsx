    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Confirmer la désactivation de l'utilisateur</DialogTitle>
              <DialogDescription>
                Êtes-vous sûr de vouloir désactiver ce compte ? Cette action est irréversible.
              </DialogDescription>
            </DialogHeader>
            ...
            {userToDelete && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Cette action désactivera le compte utilisateur. L'utilisateur ne pourra plus se connecter.
                </p>
                <div className="space-y-2">
                  <Label htmlFor="delete-password">Mot de passe Super Admin</Label>
                  <Input
                    id="delete-password"
                    type="password"
