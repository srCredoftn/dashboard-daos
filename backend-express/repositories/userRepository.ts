...
export interface UserRepository {
  ...
  create(u: Omit<PersistedUser, "id" | "createdAt"> & { id?: string; createdAt?: string }): Promise<PersistedUser>;
  updateById(id: string, updates: Partial<Omit<PersistedUser, "id" | "email" | "createdAt">>): Promise<PersistedUser | null>;
